...
public class UsersRepository {
    ...
    public void userBuysCrypto(int userId, String cryptoSymbol, BigDecimal cryptoAmount, BigDecimal cost) {
        ...
        BigDecimal userBalance = jdbcTemplate.queryForObject(balanceQuery, BigDecimal.class, userId);
        ...
        jdbcTemplate.update(updateBalanceQuery, cost, userId);


        String insertTransactionQuery = "INSERT INTO transactions (user_id, transaction_type, crypto_name, crypto_amount, currency, currency_amount) VALUES (?, 'BUY', ?, ?, 'USD', ?)";
        jdbcTemplate.update(insertTransactionQuery, userId, cryptoSymbol, cryptoAmount, cost);
    ...
    public String sellCrypto(int userId, String cryptoSymbol, BigDecimal cryptoAmount, BigDecimal usdPrice) {
        ...
        recordTransaction(userId, "SELL", cryptoSymbol, cryptoAmount, usdPrice);
    ...
    private void recordTransaction(int userId, String type, String symbol, 
